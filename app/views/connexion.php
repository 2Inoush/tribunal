 ...
 *
 * La page connexion.php a prepare $erreurs et $email.
 */
?>

<div class="max-w-md mx-auto bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8">

    <h1 class="text-2xl font-bold mb-1" style="font-family: Georgia, serif;">Entrer au tribunal</h1>
    <p class="text-sm text-gray-600 mb-6">
        Connectez-vous pour voter et défendre vos causes.
    </p>
    ...
    <form method="post" action="" class="space-y-4" novalidate>
        ...
        <button type="submit"
                class="w-full rounded bg-encre py-2.5 font-semibold text-white hover:bg-gray-800">
            Se connecter
        </button>
    ...
    <p class="mt-6 text-center text-sm text-gray-600">
        ...
        <a href="inscription.php" class="font-medium underline hover:text-dore">S'inscrire</a>
    </p>
